...
# vim: sw=4 et tw=100
"""
code for MNN-H2. Non-translation invariant case: Mixture of LC and Conv1D
reference:
...
from keras.layers import Input, Conv1D, LocallyConnected1D, ZeroPadding1D, Add, Reshape, Flatten, Lambda
...
outputfilename = log_path + 'tH2MixL' + str(k_multigrid) + 'Nc' + str(N_cnn) + 'Al' + str(alpha)
...
tr_os = open('trainresultH2Mix.txt', "a")
